...
ATTRIBUTION ACCURACY. All David Mason & Associates work used an enterprise chat plan, never local or offline inference. His local and offline inference work belongs only to Free Parameter LLC and his personal projects. Never state or imply that local inference produced anything at the firm.
